...
function BuildTechData()
    ...
    local techData = { 
		...
		//{ [kTechDataId] = kTechId.ExoStructureAbility,  [kTechDataTooltipInfo] = "MARINE_BUILD_TOOLTIP", [kTechDataPointValue] = kWeaponPointValue,    [kTechDataMapName] = ExoStructureAbility.kMapName, [kTechDataDisplayName] = "MARINE_BUILD",         [kTechDataModel] = Welder.kModelName, [kTechDataDamageType] = kWelderDamageType, [kTechDataCostKey] = kWelderCost, },
        ...
        { [kTechDataId] = kTechId.PrototypeLab, [kTechDataHint] = "PROTOTYPE_LAB_HINT", [kTechDataGhostModelClass] = "MarineGhostModel",  [kTechDataRequiresPower] = false,  [kTechDataMapName] = PrototypeLab.kMapName,  [kTechDataNotOnInfestation] = kPreventMarineStructuresOnInfestation,   [kTechDataCostKey] = kPrototypeLabCost,                     [kTechDataResearchTimeKey] = kPrototypeLabBuildTime,       [kTechDataDisplayName] = "PROTOTYPE_LAB", [kTechDataModel] = PrototypeLab.kModelName, [kTechDataMaxHealth] = kPrototypeLabHealth, [kTechDataPointValue] = kPrototypeLabPointValue, [kTechDataTooltipInfo] = "PROTOTYPE_LAB_TOOLTIP", [kTechDataObstacleRadius] = 0.5},
        ...
        { [kTechDataId] = kTechId.ExoWelder,      [kTechDataMapName] = ExoWelder.kMapName, [kTechDataDisplayName] = "CLAW",  [kTechDataDamageType] = kClawDamageType , [kTechDataDamageType] = kWelderDamageType,} ,
        { [kTechDataId] = kTechId.ExoFlamer,      [kTechDataMapName] = ExoFlamer.kMapName, [kTechDataDisplayName] = "CLAW",  [kTechDataDamageType] = kClawDamageType , [kTechDataDamageType] = kWelderDamageType,} ,
        { [kTechDataId] = kTechId.ExoScan,      [kTechDataMapName] = ExoScan.kMapName, [kTechDataDisplayName] = "CLAW",  } ,
        ...
        { [kTechDataId] = kTechId.ClawExoWelderExosuit,     [kTechIDShowEnables] = false,       [kTechDataDisplayName] = "CLAWRAILGUN_EXOSUIT", [kTechDataMapName] = "exo",               [kTechDataCostKey] = kClawExoWelderExosuitCost, [kTechDataHotkey] = Move.E, [kTechDataTooltipInfo] = "CLAWRAILGUN_EXOSUIT_TECH_TOOLTIP", [kTechDataSpawnHeightOffset] = kCommanderEquipmentDropSpawnHeight},
       ...
       // [kTechDataId] = kTechId.BuildAbility1,      [kTechDataMapName] = DropStructureAbility1.kMapName,            [kTechDataDisplayName] = "BUILD_ABILITY", [kTechDataTooltipInfo] = "BUILD_ABILITY_TOOLTIP"},
