...
kPlayerStatus = enum( { "Hidden", "Dead", "Evolving", "Embryo", "Commander", "Exo", "GrenadeLauncher", "ExoScan","Rifle", "Shotgun", "Flamethrower", "Void", "Spectator", "Skulk", "Gorge", "Fade", "Lerk", "Onos" } )
...
kDeathMessageIcon = enum( { 'None', 
                            ...
                            'Mine', 'Gore', 'Spit', 'Jetpack', 'Claw','ExoWelder','ExoFlamer','ExoScan',
