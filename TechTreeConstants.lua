...
kTechId = createTechIdEnum({
    ...
    'ClawRailgunTech', 'ClawRailgunExosuit','ClawExoWelderExosuit','ClawExoFlamerExosuit',
    ...
    // Weapons 
    'Rifle', 'Pistol', 'Shotgun', 'HeavyRifle', 'Claw','ExoWelder', 'ExoFlamer','ExoScan','Minigun', 'Railgun', 'GrenadeLauncher', 'Flamethrower', 'Axe', 'LayMines', 'Welder',
